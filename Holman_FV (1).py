...
def holman_ari():
    ...
    TESTUSER = "xxxxxxxxxxxxxxxxxxxxxxxxxx"
    TESTPW = "xxxxxxx"
    ...
    for x in Pages:
        ...
        test_3.to_csv(Filename_Fuel,index=False)
    
    
    
    '''Maintainence table'''
    current_datetime_Maintainence=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Maintainence=str(current_datetime_Maintainence)
    Filename_Maintainence="Maintenance "+str_current_datetime_Maintainence+".csv"
    ...
    for x_maintenance in Pages_maintenance:
        ...
        test_3_maintenance.to_csv(Filename_Maintainence,index=False)
    
    '''Inventory table'''
    current_datetime_Inventory=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Inventory=str(current_datetime_Inventory)
    Filename_Inventory="Inventory "+str_current_datetime_Inventory+".csv"
    ...
    for x_inventory in Pages_inventory:
        ...
        test_3_inventory.to_csv(Filename_Inventory,index=False)
    
    '''Accident table'''
    current_datetime_Accident=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Accident=str(current_datetime_Accident)
    Filename_Accident="Accident "+str_current_datetime_Accident+".csv"
    ...
    for x_accident in Pages_accident:
        ...
        test_3_accident.to_csv(Filename_Accident,index=False)
    
    
    '''Contact table'''
    current_datetime_Contact=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Contact=str(current_datetime_Contact)
    Filename_Contact="Contact "+str_current_datetime_Contact+".csv"
    ...
    for x_contact in Pages_contact:
        ...
        test_3_contact.to_csv(Filename_Contact,index=False)
        
    '''PM_reminder table'''
    current_datetime_PM_reminder=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_PM_reminder=str(current_datetime_PM_reminder)
    Filename_PM_reminder="PM_reminder "+str_current_datetime_PM_reminder+".csv"
    ...
    for x_PM_reminder in Pages_PM_reminder:
        ...
        test_3_PM_reminder.to_csv(Filename_PM_reminder,index=False)
        
        
        
    '''Violation table'''
    current_datetime_Violation=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Violation=str(current_datetime_Violation)
    Filename_Violation="Violation "+str_current_datetime_Violation+".csv"
    ...
    for x_violation in Pages_violation:
        ...
        test_3_violation.to_csv(Filename_Violation,index=False)
        
    '''ODOMETER HISTORY table'''
    current_datetime_Odometer=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Odometer=str(current_datetime_Odometer)
    Filename_Odometer="Odometer "+str_current_datetime_Odometer+".csv"
    ...
    for x_odometer in Pages_odometer:
        ...
        test_3_odometer.to_csv(Filename_Odometer,index=False)
        
    '''ORDER STATUS table'''
    current_datetime_Order_Status=datetime.now().strftime("%Y-%m-%d %H-%M-%S")
    str_current_datetime_Order_Status=str(current_datetime_Order_Status)
    Filename_Order_Status="Order_Status "+str_current_datetime_Order_Status+".csv"
    ...
    for x_order in Pages_order:
        ...
        test_3_order.to_csv(Filename_Order_Status,index=False)
